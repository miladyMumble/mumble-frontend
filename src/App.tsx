...
const App = () => {
  ...
  return (
    <Wrapper style={{background: 'linear-gradient(#d9f0d6, #f4ffee, #f4ffee, white, white)'}}>
      ...
      <h4 style={{marginBottom: "3%"}} className="please-text"><span className="hover2" style={{textDecoration: 'underline'}} onClick={() => {window.open('https://miladymaker.net/')}}>Made with ❤️ by 🧀</span></h3>
    </Wrapper>
  );
};
